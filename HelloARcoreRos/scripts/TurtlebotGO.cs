...
public class TurtlebotGO : MonoBehaviour
{
    ...
    private GameObject[] m_Roots = new GameObject[1];
    ...
    public void Clear()
    {
        if (m_Roots != null)
        {
            foreach (GameObject child in m_Roots)
            {
                child.GetComponent<GoogleARCore.Examples.ObjectManipulation.Manipulator>().Deselect();
