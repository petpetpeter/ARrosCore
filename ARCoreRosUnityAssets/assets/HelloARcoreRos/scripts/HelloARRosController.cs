...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    /// </summary>
    public class HelloARRosController: MonoBehaviour
    {
        //Pass Base Object Here
        ...
        public void Update()
        {
            ...
            if (foundHit)
            {
                ...
                else
                {
                    ...
                    // camera).
                    baseObject.transform.Rotate(0, 0, 0, Space.Self);
                    ...
                    baseObject.transform.position = anchor.transform.position;

                    // Initialize Instant Placement Effect.
                    /*if (hit.Trackable is InstantPlacementPoint)
                    {
                        baseObject.GetComponentInChildren<InstantPlacementEffect>()
